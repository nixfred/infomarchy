...
async function runCollector() {
  ...
  const [cpuS, memS, diskS, netS, pingS, gpuS, sessions, ollama, externalIpS, github, gitea] = await Promise.all([
    Promise.resolve(cpu()), Promise.resolve(mem()), disk(), net(), ping(), gpu(), liveSessions(pids), ollamaState(), externalIp(), githubActivity(), giteaActivity(), refreshGrokBilling(), refreshClaudeAuthIfNeeded(),
  ]);
